...
all: ./values.o ./piece.o ./field.o ./move.o ./board.o ./endgame.o ./match.o ./threading.o ./test.o ./engine.o \

	$(CC) -Wall --std=c++17 -lpthread -O3 \
	./values.o ./piece.o ./field.o ./move.o ./board.o ./endgame.o ./match.o ./threading.o ./test.o ./engine.o -o ./engine
